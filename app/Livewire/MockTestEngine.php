...
class MockTestEngine extends Component
{
    ...
    public function mount(MockTest $mockTest, bool $practiceMode = false): void
    {
        $this->mockTest = $mockTest;
        $this->practiceMode = $practiceMode;
        $this->questions = $mockTest->questions->toArray();
        $this->remainingSeconds = $mockTest->duration_minutes * 60;
    ...
    public function startExam(?string $mode = null): void
    {
        ...
        $this->currentIndex = 0;
        $this->answers = [];
        $this->remainingSeconds = $this->mockTest->duration_minutes * 60;
        $this->elapsedSeconds = 0;

        $this->mockTest->increment('attempt_count');
        $this->mockTest->refresh();
    }
    ...
    public function calculateScore(): void
    {
        ...
        if ($this->practiceMode) {
            ...
            $negativeValue = (float) $this->mockTest->negative_marking_value;
    ...
    public function getWhatsAppShareUrlProperty(): string
    {
        ...
        $name = preg_match('/\d+$/', $this->mockTest->name, $matches) 
            ? 'Mock Test ' . $matches[0] 
            : $this->mockTest->name;
    ...
    {
        return view('livewire.mock-test-engine');
    }
}
